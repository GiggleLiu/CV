...
\begin{cvskills}
    ...
    \cvskill{Knowledge}{Tensor Networks, Differentiable Programming, Quantum computing, Condensed matter physics, Combinatorial optimization, High performance computing}
\end{cvskills}
