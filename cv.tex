...
\begin{cventries}
  \cventry
    {Minh-Thi Nguyen, Jin-Guo Liu, Jonathan Wurtz, Mikhail D Lukin, Sheng-Tao Wang, Hannes Pichler} % Role
    {Quantum optimization with arbitrary connectivity using Rydberg atom arrays} % Title
    {\href{https://journals.aps.org/prxquantum/abstract/10.1103/PRXQuantum.4.010316}{PRX Quantum 4, 010316}} % Location
    {2023} % Date(s)
    {
    }
  \cventry
    ...
    {\href{https://epubs.siam.org/doi/full/10.1137/22M1501787}{SIAM Journal on Scientific Computing 45, A1239}} % Location
    {2022} % Date(s)
    {}
